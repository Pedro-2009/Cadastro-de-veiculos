...
<form action="add.php" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['cpf']" data-mask="cpf">
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="cep" name="customer['zip_code']" data-mask="zip_code" onblur="pesquisacep(this.value);">
        </div>

        <div class="form-group col-md-8">
            <label for="campo1">Endereço</label>
            <input type="text" class="form-control" id="rua" name="customer['address']">
        </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="bairro" name="customer['hood']">
        </div>

        <div class="form-group col-md-3">
            <label for="campo1">Município</label>
            <input type="text" class="form-control" id="cidade" name="customer['city']">
        </div>

        <div class="form-group col-md-1">
            <label for="campo3">UF</label>
            <input type="text" class="form-control" id="uf" name="customer['state']">
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['phone']" data-mask="phone">
        </div>
