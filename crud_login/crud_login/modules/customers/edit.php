...
<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['cpf']" value="<?php echo $customer['cpf']; ?>" data-mask="cpf">
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="cep" name="customer['zip_code']" value="<?php echo $customer['zip_code']; ?>" data-mask="zip_code" onblur="pesquisacep(this.value);">
        </div>
         
        <div class="form-group col-md-8">
            <label for="campo2">Endereço</label>
            <input type="text" class="form-control" id="rua" name="customer['address']" value="<?php echo $customer['address']; ?>">
        </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="bairro" name="customer['hood']" value="<?php echo $customer['hood']; ?>">
        </div>

        <div class="form-group col-md-3">
            <label for="campo3">Município</label>
            <input type="text" class="form-control" id="cidade" name="customer['city']" value="<?php echo $customer['city']; ?>">
        </div>

        <div class="form-group col-md-1">
            <label for="campo4">UF</label>
            <input type="text" class="form-control" id="uf" name="customer['state']" value="<?php echo $customer['state']; ?>">
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['phone']" value="<?php echo $customer['phone']; ?>" data-mask="phone">
        </div>
